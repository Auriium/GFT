package com.elytraforce.gunfight.controllers.player;
...
public class DuelsPlayer {
    ...
    public Duel getSpectatingGame() {
    	return this.spectatingGame;
    }
    
    public void setSpectatingGame(Duel d) {
    	this.spectatingGame = d;
    }
    ...
    public void setSpectating(Boolean e) {
    	this.isSpectating = e;
    }
